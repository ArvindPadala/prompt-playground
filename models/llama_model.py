...
def call_llama(prompt, system_prompt="", temperature=0.7, top_p=1.0, top_k=50, ollama_url="http://localhost:11434"):
    """
    Generator that streams tokens from the Llama2 model via Ollama.
